...
`/gku-init` copies the block below into a repository's `GEMINI.md`, between the
...
Sources: [Moodle PHP coding style](https://moodledev.io/general/development/policies/codingstyle),
