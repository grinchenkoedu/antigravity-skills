...
cost discipline in `gku-reference/repo-profile.md` still holds — five files read in full, no
sub-agents.
...
- **Data-safety rules are not optional** — see `gku-reference/repo-profile.md`. A fix to code that
