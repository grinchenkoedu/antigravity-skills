...
get into the profile is `gku-reference/repo-profile.md`; this is how to use them.
...
developer's machine and credentials — say so and ask first (`gku-reference/untrusted-input.md`).
